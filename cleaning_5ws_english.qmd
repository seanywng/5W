...
We will be using data from the Education Cluster in Venezuela with partner names recoded. For another example of a cleaning script for 5Ws, please see [here](https://github.com/kenya-eie-wg/eie_wg_5ws/blob/main/5Ws_cleaning_script.Rmd).

Click [here](https://seanywng.github.io/5W/reporting_5ws_english) to jump to an example 5Ws reporting script. 
